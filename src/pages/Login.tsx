        ...
        <div className="flex flex-col h-screen md:justify-between justify-center md:py-30 md:px-25 md:pt-50 p-10">
          <div className="flex flex-col gap-2 z-99">
            ...
            <p className="text-[18px]">
              Your expertise is essential for managing our platform, and we are
              excited to support your vision for improvement and innovation.
            </p>
            ...
            <div className="flex rounded md:w-1/3 p-2 mt-4 bg-[#303030] cursor-pointer w-full">
              <div className="w-full bg-white rounded-md text-black text-center py-2">
                Login
              </div>
            </div>
          </div>
