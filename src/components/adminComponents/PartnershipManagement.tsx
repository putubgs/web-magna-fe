	...
	return (
		<>
			<section className="flex justify-between items-center bg-black border border-[#404040] p-[20px] rounded-[12px]">
				<h1 className="text-2xl font-semibold">Partnership Management Panel</h1>
				<button
				...
				<table className="table-auto w-full text-white">
					<thead>
						<tr className="border-b border-[#D4D4D4] text-left">
							...
							<th className="text-lg font-bold py-3 px-20">Logo</th>
							<th className="text-lg font-bold py-3 px-4">Partner</th>
							<th className="text-lg font-bold py-3 px-1">Actions</th>
						</tr>
					</thead>
